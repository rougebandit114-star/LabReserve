...
import { Lock, Mail, Building2, User as UserIcon, ShieldAlert, Eye, EyeOff } from "lucide-react";
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm transition-all"
                placeholder="••••••••"
              />
              <button
                type="button"
                ...
                id="toggle-show-login-password-btn"
              >
                {showPassword ? (
